...
const Text = {
    ...
    TitleAds: {
        "en": "1. Watch ads to unlock a single episode for free",
        "zh-TW": "1. 觀看廣告免費解鎖單劇",
        "ja": "1. 広告を見て単話を無料でアンロック",
        "ko": "1. 광고를 보고 단일 에피소드를 무료로 잠금 해제",
    },
    ContentAds: {
        "en": "When watching a paid episode, you can choose to watch three ads to unlock it for free. Note that you must click “Claim Reward” on the ad page for it to count as completing one ad. After completing all three ads, the current episode will play automatically.",
    ...
    TitlePayerMax: {
        "en": "2. New Payment Channel – PayerMax",
        "zh-TW": "2. 新的支付渠道 – PayerMax",
        "ja": "2. 新しい支払いチャネル – PayerMax",
        "ko": "2. 새로운 결제 채널 – PayerMax",
    },
    ContentPayerMax: {
        "en": "PayerMax will intelligently find a payment method based on your country, supporting more countries. If you encounter any issues during payment, please contact customer service @NetshortHelpbot.",
