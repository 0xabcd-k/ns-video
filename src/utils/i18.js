export const Text = {
    ...
    PriceDesc: {
        "en": "Lowest price online，Buy the series for",
        "zh-TW": "線上最低價，購買全集僅需",
        "ja": "オンライン最安値，シリーズを購入する",
        "ko": "온라인 최저가, 전체 시리즈 구매 시 단돈",
        "es": "Precio más bajo en línea, Comprar la serie para",
        "pt": "Menor preço online, Compre a série por",
        "fil": "Pinakababang presyo online, Bumili ang serye",
        "id": "Harga termurah online, Beli seri untuk",
        "it": "Prezzo più basso online, Compra la serie per",
    },
    PayAds: {
        "en": "Watch 3 ads to unlock the episode",
        "zh-TW": "觀看 3 則廣告解鎖劇集",
        "ja": "広告を3本見てエピソードをアンロック",
        "ko": "광고 3개를 보고 에피소드를 잠금 해제",
        "es": "Ver 3 anuncios para desbloquear el episodio",
        "pt": "Assista a 3 anúncios para desbloquear o episódio",
        "fil": "Tingnan ang 3 ad upang i-unlock ang episodes",
        "id": "Tonton 3 iklan untuk membuka episode",
        "it": "Guarda 3 annunci per sbloccare l'episodio",
    },
    PayAdsNeedMore: {
