export const Text = {
    ...
    Card: {
        "en": <>,<br/>watch for a week<br/>Click to Buy</>,
        "zh-TW": <>,<br/>持續看一週<br/>點擊購買</>,
        "ja": <>,<br/>1週間見放題<br/>クリックして購入</>,
        "ko": <>,,<br/>일주일 동안 시청 가능<br/>클릭하여 구매</>,
        "es": <>,<br/>ver durante una semana<br/>Hacer clic para comprar</>,
        "pt": <>,<br/>assistir por uma semana<br/>Clique para comprar</>,
        "fil": <>,<br/>manood ng isang linggo<br/>I-click para bumili</>,
        "id": <>,<br/>nonton selama satu minggu<br/>Klik untuk membeli</>,
        "it": <>,<br/>guarda per una settimana<br/>Clicca per acquistare</>,
    },
    Free: {
        "en": "Unlimited",
        "zh-TW": "無限",
