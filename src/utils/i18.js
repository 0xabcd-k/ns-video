export const Text = {
    ...
    Card: {
        "en": <>$<span>7.99</span>,<br/>watch for a week<br/>Click to Buy</>,
        "zh-TW": <><span>7.99</span>美元,<br/>持續看一週<br/>點擊購買</>,
        "ja": <><span>7.99</span>ドル,<br/>1週間見放題<br/>クリックして購入</>,
        "ko": <><span>7.99</span>달러,,<br/>일주일 동안 시청 가능<br/>클릭하여 구매</>,
        "es": <><span>7.99</span>9 USD,<br/>ver durante una semana<br/>Hacer clic para comprar</>,
        "pt": <>US$<span>7,99</span>,<br/>assistir por uma semana<br/>Clique para comprar</>,
        "fil": <>US$<span>7.99</span>,<br/>manood ng isang linggo<br/>I-click para bumili</>,
        "id": <>US$<span>7,99</span>,<br/>nonton selama satu minggu<br/>Klik untuk membeli</>,
        "it": <><span>7,99</span> USD,<br/>guarda per una settimana<br/>Clicca per acquistare</>,
    },
    Login: {
        "en": "Login",
        "zh-TW": "登入",
