export const Text = {
    ...
    LoginEmailToast: {
        ...
        "ko-KR": "시청 진행 상황을 유지하려면 계정에 로그인해 주세요.",
    },
    OrderWaitToast: {
        ...
        "ko-KR": "주문 처리에는 다소 시간이 걸릴 수 있습니다. 결제 후에도 적용되지 않는 경우, 새로고침해 보시기 바랍니다.",
    },
    Purchased: {
        "en-US": "Purchased",
        "zh-TW": "已購買",
    ...
    EmailCodeExpire: {
        ...
        "ko-KR": "인증 코드가 만료되었습니다. 다시 받아 주세요.",
    },
    LoginFail: {
        "en-US": "Login failed.Pls try again",
        "zh-TW": "登入失敗，請再試一次",
        "ja": "ログイン失敗。再度お試しください。",
        "ko-KR": "로그인에 실패했습니다. 다시 시도해 주세요.",
    },
    Confirm: {
        "en-US": "Confirm",
        "zh-TW": "確認",
    ...
    BottomLine: {
        ...
        "ko-KR": "NetShort | 모든 저작권 소유 | 2024 NETSTORY PTE. LTD.",
    },
    NotFound: {
        "en-US": "404 Not Found",
        "zh-TW": "404 網頁不存在",
        "ja": "404 見つかりません",
        "ko-KR": "404 페이지를 찾을 수 없습니다",
    },
    DramaFinish: {
        "en-US": "Drama Finish...",
        "zh-TW": "劇集已完結…",
        "ja": "ドラマ終了…",
        "ko-KR": "드라마가 이미 종료되었습니다...",
    },
    NeedPurchase: {
        "en-US": "Need Purchase",
        "zh-TW": "需要購買",
    ...
    RegisterTip: {
        ...
        "ko-KR": "입력하신 계정이 등록되지 않은 경우, 자동으로 새 계정을 생성합니다.",
    },
    AccountTip: {
    ...
    NoRedeem: {
        ...
        "ko-KR": "본 드라마는 현재 선물 코드를 사용할 수 없습니다",
    },
    ShareTitle: {
        "zh-TW": "你想分享到哪裡？",
    ...
    ReviewTip: {
        ...
        "ko-KR": "고객님의 의견과 연락처를 남겨주시면 확인 후 신속히 처리하고 개선하겠습니다. 고객님의 소중한 의견이 도움이 될 경우, 감사의 의미로 소정의 보상을 드립니다.",
    },
    LiveAgent: {
        "zh-TW": "人工客服",
        "en-US": "Live Agent",
    ...
    RechargeTip: {
        ...
        "ko-KR": "이 주문은 본 사이트에서만 시청할 수 있습니다",
    },
    RechargeRecord: {
        "zh-TW": "充值紀錄",
    ...
    RechargeReportTip: {
        ...
        "ko-KR": "여기를 눌러 교환 코드를 사용해 단편극을 받으세요. 결제 오류를 신고하면 무료 시청 기프트 코드를 드립니다!",
    },
    KocTitle: {
